<div className='w-full h-[90vh]'>
      ...
      <div className='absolute top-[40%] w-full md:-[50%] max-w-[600px] h-full flex flex-col text-white p-4'>
        ...
        <p> 
        Exploring new Books unveils the richness of human diversity and the vastness of natural wonders, 
        providing unforgettable experiences and lifelong memories.Each book is a masterpiece of its own, 
